...
%160 ?   
   ...
   at- ten- dre qu'il n'en soit plus temps 
   vou- lez- vous, vou- lez- vous pour en fai re u- sa- ge 
   at- ten- dre qu'il n'en soit plus temps 
}
% <<
%    \new Voice = "mel" {  \melody }
